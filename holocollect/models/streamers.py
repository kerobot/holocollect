...
from holocollect.models.streamer import Streamer

class Streamers:
    """
    Streamersオブジェクトのコレクションクラス
    """
    def __init__(self):
        """
        Streamersクラスのインスタンスを生成する
        """
    ...
    def get_streamer_by_name(self, name: str) -> Streamer | None:
        """
        指定した名前（短縮名）のStreamerオブジェクトを返す
